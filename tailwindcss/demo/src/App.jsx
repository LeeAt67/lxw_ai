...
function App() {
  return (
    <div className="max-w-xs rounded-lg overflow-hidden bg-white transition-transform duration-300 hover:shadow-xl hover:scale-105 mx-auto">
      {/* AI语义 */}
      {/* <h1 className="text-4xl font-bold underline">hello world ,tailwindcss</h1> */}
      ...
      <div className="p-4">
        <h3 className="text-lg fpmt-semibold text-gray-800 line-clamp-1">
          Premium Wireless Headphones Premium Wireless Headphones Premium
          Wireless Headphones
        </h3>
