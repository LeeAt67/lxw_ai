...
// // js 主动的去拉取http 接口
// // web 1.0 时代 html/css/js  服务器端java 返回的 js 只能简单的交互
// // web 2.0 时代 js 主动的请求后端服务器  动态页面
// fetch('https://api.github.com/users/LeeAt67/repos')
//   .then(res => res.json())
//   .then(data => {
//     // console.log(data);
...
const headers = {
  ...
  // 授权
  Authorization: 'Bearer sk-1601fac9c3e3412fb163002302ed453a'
}
// 请求体
const payload = {
  model: 'deepseek-chat',
